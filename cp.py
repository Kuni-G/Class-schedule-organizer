...
print(validate_class_input("Monday", "10:00", "Math"))
print(validate_class_input("", "10:00", "Math"))
print(validate_assignment_input("Physics", "Homework 1", "2025-06-15"))

# Example for checking time conflict (you'd need to define existing_schedule)
sample_schedule = {
    "Monday": [
        {'class_name': 'History', 'time': '09:00'}
    ]
}
print(check_for_time_conflict(sample_schedule, "Monday", "09:30"))
print(check_for_time_conflict(sample_schedule, "Tuesday", "10:00"))
